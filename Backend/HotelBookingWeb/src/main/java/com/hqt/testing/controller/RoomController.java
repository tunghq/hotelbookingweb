...
import com.hqt.testing.exception.PhotoRetrievalException;
...
public class RoomController {
    ...
    public ResponseEntity<Optional<RoomResponse>> getRoomById(@PathVariable int roomId){
    ...
    private List<BookedRoom> getAllBookingsByRoomId(int roomId) {
