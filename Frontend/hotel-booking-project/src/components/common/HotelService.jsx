        ...
        <Container className='mb-2'>
            ...
            <Row>
                ...
                <h4 className='text-center'>
                    Services at <span className='hotel-color'>Thousand-Star Hotel </span>
                ...
                <Col>
                    <Card>
                        <Card.Body>
                            ...
                            <Card.Text>Start your day with a delicous breakfast buffet.</Card.Text>
                ...
                <Col>
                    <Card>
                        <Card.Body>
                            ...
                            <Card.Text>Park your car conveniently in out on-site parking lot.</Card.Text>
                        </Card.Body>
